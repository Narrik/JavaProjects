...
public class Dalek3Test {
	...
	/**
	 * Temporarily captures the output to the standard output stream. This
	 * method is run before every testcase.
	 */
	@Before
	...
	/**
	 * Restores the standard output stream. This method is run after every
	 * testcase.
	 */
	@After
